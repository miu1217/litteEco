...
<!--         <div class="mysidebar">
      ...
      <div class="mypage-info" id="mypage-info">
        ...
        <form class="myform-tag" action="update.me" method="post" id="updateForm">
              ...
              <div class="memberInfo">
                <h4>생년월일</h4>
                <input type="text" name="birth" placeholder="" value="${loginUser.birth}">
              </div>
              <div class="memberInfo">
                <h4>이메일</h4>
              ...
              <div class="memberInfo">
                <h4>휴대전화번호</h4>
                <input type="text" name="phone" required value="${loginUser.phone}" maxlength="11">
              </div>
        ...
        $('#showPwd').change(function() {
            ...
            $(function(){
              ...
              $("#updateBtn").click(function(){
                ...
                var email = $("#email");
                var regExp = /^[0-9A-z]+@[0-9A-z]+\.[a-zA-Z]{2,4}$/i;
