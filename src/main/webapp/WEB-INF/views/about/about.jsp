                ...
                <tr>
                    <td >
                        <ul class="data-area" id="data1">
                            ...
                            <li class="num" id="open-result-1">19,738<span id="unit">t</span></li>
                            <li class="line"></li>
                            <li></li>
                        </ul>
                    </td>
                    <td>
                        ...
                        <ul class="data-area" id="data2">
                            ...
                            <li  class="num" id="open-result-2">17,161<span id="unit">t</span></li>
                            <li class="line"></li>
                            <li></li>
                        </ul>
                    ...
                    <td>
                        ...
                        <ul class="data-area" id="data3">
                            ...
                            <li  class="num">86.9<span id="unit">%</span></li>
                            <li class="line"></li>
                            <li></li>
                        </ul>
