...
public class recycleBoardController {
	...
	public String recycleBList(@RequestParam(value = "currentPage", defaultValue = "1") int currentPage, Model model) {
		// 페이징 처리된 게시글 조회하기
	...
	public String insertBoard(recycleBoard rb, boardAttachment bat, MultipartFile upfile, HttpSession session) {
	...
	public String recycleUpdate(int rbno, Model model) {
	...
	public String recycleUpdate(recycleBoard rb, @RequestParam("rbno") int rbno, MultipartFile reUpFile, Model model,
			HttpSession session) {
