...
public class MypageDao {
	...
	public ArrayList<SearchEco> selectLikeList(SqlSessionTemplate sqlSession, int memberNo) {

		return (ArrayList)sqlSession.selectList("mypageMapper.selectLikeList",memberNo);
	}
